...
\begin{note}
Since a member function cannot be subject to a non-defining declaration
outside of its class definition\iref{class.mfct}, a \grammarterm{nodeclspec-function-declaration}
